                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ back_route('extensions.mailbox.mailbox.index') }}">{{ Lang::get('administrable-mailbox::translations.label') }}</a>
                            </li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h3 class="card-title">{{ Lang::get('administrable-mailbox::translations.view.reading') }}</h3>
                        <div class="btn-group">
                            <a href="{{ back_route('extensions.mailbox.mailbox.destroy', $mailbox) }}" class="btn btn-danger"
                                data-method="delete"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card-body p-0">
                                <div class="mailbox-read-info mb-4">
                                    <p>{{ $mailbox->email }} | {{ $mailbox->phone_number }}
                                        <span
                    ...
                    <div class="card">
                        <div class="card-header ml-4">
                            <h3 class="card-title font-weight-bold"><i class="fa fa-comments"></i>
                                {{ Lang::get('administrable-mailbox::translations.view.notes') }} ({{ $mailbox->notes->count() }})
                            </h3>
                        </div>
                        <div class="card-body">
