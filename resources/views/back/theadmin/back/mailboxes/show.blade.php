...
<div class="main-content">
    <div class="card ">
        <nav aria-label="breadcrumb" class="d-flex justify-content-end" style="padding-top:10px;padding-right:20px;">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ $mailbox->name }}</li>
            </ol>
        </nav>
            ...
            <div class="card-title flexbox">
                ...
                <div>
                    ...
                    <div class="collapse no-collapsing cursor-text" id="email-info-2">
                        <small class="d-inline-block w-40px mt-1">{{ Lang::get('administrable-mailbox::translations.view.from') }}:</small>
    ...
    <div class="fab fab-fixed">
        ...
        <ul class="fab-buttons">
            ...
            <li><a class="btn btn-float btn-sm btn-danger" href="{{ back_route('extensions.mailbox.mailbox.destroy', $mailbox) }}" data-method="delete"
            data-confirm="{{ Lang::get('administrable-mailbox::translations.view.destroy') }}" title="{{ Lang::get('administrable-mailbox::translations.default.delete') }}" data-provide="tooltip"
                    data-placement="left"><i class="fa fa-trash"></i> </a></li>
