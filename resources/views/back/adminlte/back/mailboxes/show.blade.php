                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header d-flex justify-content-between ">
                            ...
                            <a href="{{ back_route('extensions.mailbox.mailbox.destroy', $mailbox) }}" data-method="delete"
                                ...
                                class="btn btn-danger"><i class="fas fa-trash"></i> {{ Lang::get('administrable-mailbox::translations.default.delete') }}</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body p-0">
                            <div class="mailbox-read-info">
                                <h6>{{ Lang::get('administrable-mailbox::translations.view.name') }}: {{ $mailbox->name }}</h6>
                                <h6>{{ Lang::get('administrable-mailbox::translations.view.email') }}: {{ $mailbox->email }}
                                    <span
